...
namespace MusicPlayer
{
    public partial class MainWindow : Window
    {
        ...
        private void AddButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == true)
            {
                ...
                foreach (string file in openFileDialog.FileNames)
                {
                    ...
                    string fileNameWithoutExtension = Path.GetFileNameWithoutExtension(file);
                    string destinationPath = GetUniqueDestinationPath(musicFolder, fileName);
        ...
        private void MusicList_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                _currentTrackIndex = MusicList.Items.IndexOf(selectedItem);
        ...
        private void PlayTrack()
        {
            ...
            var filePath = _musicFiles[_currentTrackIndex];
            ...
            CurrentSongTextBlock.Text = Path.GetFileName(filePath);
            _timer.Start();
        }
        ...
        private void NextTrack()
        {
            ...
            {
                _currentTrackIndex = _shuffledIndices[(_shuffledIndices.IndexOf(_currentTrackIndex) + 1) % _shuffledIndices.Count];
            }
            else
            {
                _currentTrackIndex++;
