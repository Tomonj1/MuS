# RU Примечание
Увы, при установке данное приложение помечается как вирус. Я уже решаю эту проблему.
# ENG Note
Unfortunately, this application is flagged as a virus during installation. I am already working on resolving this issue.
...
The music player also supports convenient features such as track selection, play/pause, volume control, and shuffle mode. It is designed to be simple and intuitive to use. If you want to modify your music library, just delete, rename, or add files as needed.
